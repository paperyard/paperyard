...
<div class="row" ng-controller="ftp_controller">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 waitme">
        ...
        <button type="button" class="btn btn-primary waves-effect btn-lg" ng-click="downloadFiles()"><b style="font-size:16px">Download</b></button>
        <!-- TABLE FILENAMES -->
...
$scope.downloadFiles = function(){
    ...
    if($scope.selectedDocs.length>0){
        ...
        $http({method:'POST',url:'/ftp_connect/download_files', data}).success(function(data){
        	...
        	$scope.showNotification("Files successfully downloaded.","bg-blue")
        	console.log(data);
