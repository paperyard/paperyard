...
// Check for installtion status
Route::post('/check_installation_status',     'userController@checkForInstallationStatus');
...
// ---------------------------------------------------------------------------------------------------------
	...
	Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['middleware' => 'auth_user'], function () {
            ...
            Route::get(  '/getBarKnob',                            'dashboardController@returnBarKnobDatas');
      	...
      	Route::get(  '/folders/return',                        'foldersController@returnFolders');
            ...
            Route::post( '/settings/reset_filename_format',        'settingsController@resetFilenameFormat');
            ...
            Route::post( '/imap/folder_select',                     'imap_controller@selectFolder');
            Route::post( '/imap/refresh_credentials',               'imap_controller@refreshCredentials');
            ...
            // WEBDAV =========================================================================================================
            Route::get(  '/webdav_create_credentials',                          'webdav_controller@index');
            Route::post( '/webdav_create_credentails/new_credential',           'webdav_controller@saveNewCredentails');
            Route::get(  '/webdav_create_credentials/list_of_credentials',      'webdav_controller@returnWEBDAVCredentials');   
            Route::post( '/webdav_create_credentials/delete',                   'webdav_controller@deleteWEBDAVCredentials');
            //--connect
            Route::get(  '/webdav_connect/{webdav_id}',                         'webdav_controller@connectWEBDAV'); 
            Route::post( '/webdav_connect/webdav_files',                        'webdav_controller@WEBDAV_connect_get_files'); 
            Route::post( '/webdav_connect/download_files',                      'webdav_controller@downloadFiles');
